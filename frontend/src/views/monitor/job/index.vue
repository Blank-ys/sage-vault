<template>
   <div class="management-page">
      <management-page-header title="定时任务" subtitle="维护调度任务、cron 表达式与执行策略" />
      ...
      <el-table class="management-table" v-loading="loading" :data="jobList" @selection-change="handleSelectionChange">
