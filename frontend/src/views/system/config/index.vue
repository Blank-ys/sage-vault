<template>
   <div class="management-page">
      <management-page-header title="参数设置" subtitle="维护系统运行参数；内置参数请谨慎修改" />
      ...
      <el-table class="management-table" v-loading="loading" :data="configList" @selection-change="handleSelectionChange">
