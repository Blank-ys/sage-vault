<template>
   <div class="management-page">
      <management-page-header title="通知公告" subtitle="维护系统公告内容与发布状态" />
      ...
      <el-table class="management-table" v-loading="loading" :data="noticeList" @selection-change="handleSelectionChange">
