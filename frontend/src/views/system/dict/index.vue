<template>
   <div class="management-page">
      <management-page-header title="字典管理" subtitle="维护字典类型与缓存" />
      ...
      <el-table class="management-table" v-loading="loading" :data="typeList" @selection-change="handleSelectionChange">
